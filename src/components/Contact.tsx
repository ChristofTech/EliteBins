          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="p-field">
                ...
                <InputText
                  ...
                  className={`p-1 w-full ${errors.name ? "p-invalid" : ""}`}
                />
                {errors.name && (
                  <Message
                    severity="error"
              ...
              <div className="p-field">
                ...
                <InputText
                  ...
                  className={`p-1 w-full ${errors.email ? "p-invalid" : ""}`}
                />
                {errors.email && (
                  <Message
                    severity="error"
            ...
            <div className="p-field">
              ...
              <InputTextarea
                ...
                className={`p-1 w-full ${errors.message ? "p-invalid" : ""}`}
              />
              {errors.message && (
                <Message
                  severity="error"
